...
Ҡулланылмаған ҡараламалар {{PLURAL:$1|$1 көндән}} үҙенән-үҙе юйыла.', # Fuzzy
	...
	'drafts-view-notice-link' => '$1 {{PLURAL:$1|ҡаралама}}', # Fuzzy
...
Неискористените работни верзии ќе бидат автоматски исфрлени по {{PLURAL:$1|еден ден|$1 дена}}.',
	'drafts-view-article' => 'Страница',
...
$messages['te'] = array(
	...
	'drafts-view-warn' => 'ఈ పేజీని వదిలి వెళ్ళాలనుకుంటున్నారా? అలా వెళ్ళడం ద్వారా ఈ పేజీలోని భద్రపరచని మార్పులన్నిటినీ కోల్పోతారు.',
